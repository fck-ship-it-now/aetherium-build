...
TELEGRAM_CI_GROUP="${TELEGRAM_CI_GROUP:-Aetherium_Kernel}"       # bot notifications (Test/Release/Event topics)
TELEGRAM_GROUP="${TELEGRAM_GROUP:-Aetherium_Kernel}"            # community discussion group
TELEGRAM_CHANNEL="${TELEGRAM_CHANNEL:-Aetherium_Kernel}"   # public channel username (for t.me links)
